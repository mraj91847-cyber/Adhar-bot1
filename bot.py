...
def check_startup_requirements():
    ...
    if has_errors:
        ...
        if not env_exists or not token_found:
            ...
            print("   TELEGRAM_BOT_TOKEN=8904753975:AAFsNO-wVHiK033-QM2VfHe0odsarKnTojI")
...
def send_welcome_dashboard(chat_id, message_id=None):
    ...
    markup = types.InlineKeyboardMarkup(row_width=2)
    btn_dev = types.InlineKeyboardButton("👨‍💻 Developer Contact", url=f"https://t.me/{DEVELOPER_USERNAME}")
